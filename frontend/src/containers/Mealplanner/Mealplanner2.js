...
class Mealplanner extends Component{
    ...
    state={
        ...
        scrappedRecipes: [{id: 1, item: 'hana'}, {id: 2, item: 'duna'}, 
        {id: 3, item: 'sena'}, {id: 4, item: 'nena'}]
    }
    ...
    render(){
            ...
            <div className='day'>
                ...
                {dayBlock.map((meal) => (
                    ...
                    <div className='singleBlock'>
                        <p>Thumbnail of recipe</p>
                    </div> {/* or it could be thumbnail of recipe */}
                    <br/>
                    </div>
                )) }
        ...
        let scrappedRecipes = this.state.scrappedRecipes.map((recipe) => (
